...
export default function TestimonialSlider() {
  ...
  <div className="relative rounded-[1rem] overflow-hidden bg-gradient-to-r from-[#9333EA] via-[#3B82F6] to-[#06B6D4] pb-16 pt-8 px-6 sm:px-10 md:px-12">
    <div className="p-6 md:p-12 flex flex-col md:flex-row items-center gap-8">
      ...
      <div className="flex-1 text-white">
        <p className="text-lg sm:text-xl mb-6 sm:w-[850px]">
          {testimonials[currentSlide].quote}
        </p>
        <h3 className="text-[25px] font-[700] mb-2 w-[191px] h-[34px] font-[Al Nile] leading-[34.13px]">
          {testimonials[currentSlide].name}
        </h3>
        <p className="text-white/90 mb-4 sm:w-[314px] text-[20px] font-[Al Nile] font-[400] leading-[27.3px]">
        ...
        {testimonials[currentSlide].platform === "discord" && (
          <div className="flex items-center gap-2">
            ...
            <span className="uppercase tracking-wider text-sm font-medium">Discord</span>
          </div>
        )}
      </div>
    </div>
